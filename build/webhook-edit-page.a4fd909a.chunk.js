...
const EventInput = ({ isDraftAndPublish }) => {
  ...
  return /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 1 }, /* @__PURE__ */ react.createElement(dist.FieldLabel, null, formatMessage({
...
const Status = ({ isPending, statusCode }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  if (isPending) {
    return /* @__PURE__ */ react.createElement(dist.Flex, { gap: 2, alignItems: "center" }, /* @__PURE__ */ react.createElement(Icon, { as: icons_dist.Loader }), /* @__PURE__ */ react.createElement(dist.Typography, null, formatMessage({ id: "Settings.webhooks.trigger.pending", defaultMessage: "pending" })));
  }
  if (statusCode >= 200 && statusCode < 300) {
    return /* @__PURE__ */ react.createElement(dist.Flex, { gap: 2, alignItems: "center" }, /* @__PURE__ */ react.createElement(Icon, { as: icons_dist.Check, color: "success700" }), /* @__PURE__ */ react.createElement(dist.Typography, null, formatMessage({ id: "Settings.webhooks.trigger.success", defaultMessage: "success" })));
  }
  if (statusCode >= 300) {
    return /* @__PURE__ */ react.createElement(dist.Flex, { gap: 2, alignItems: "center" }, /* @__PURE__ */ react.createElement(Icon, { as: icons_dist.Cross, color: "danger700" }), /* @__PURE__ */ react.createElement(dist.Typography, null, formatMessage({ id: "Settings.error", defaultMessage: "error" }), " ", statusCode));
  }
  return null;
};
Status.propTypes = {
...
const CancelButton = ({ onCancel }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(dist.Flex, { justifyContent: "flex-end" }, /* @__PURE__ */ react.createElement("button", { onClick: onCancel, type: "button" }, /* @__PURE__ */ react.createElement(dist.Flex, { gap: 2, alignItems: "center" }, /* @__PURE__ */ react.createElement(dist.Typography, { textColor: "neutral400" }, formatMessage({ id: "Settings.webhooks.trigger.cancel", defaultMessage: "cancel" })), /* @__PURE__ */ react.createElement(Icon, { as: icons_dist.Cross, color: "neutral400" }))));
};
...
const WebhookForm = ({
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    ), /* @__PURE__ */ react.createElement(dist.ContentLayout, null, /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 4 }, showTriggerResponse && /* @__PURE__ */ react.createElement("div", { className: "trigger-wrapper" }, /* @__PURE__ */ react.createElement(
    ...
    )), /* @__PURE__ */ react.createElement(dist.Box, { background: "neutral0", padding: 8, shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 6 }, /* @__PURE__ */ react.createElement(dist.Grid, { gap: 6 }, /* @__PURE__ */ react.createElement(dist.GridItem, { col: 6 }, /* @__PURE__ */ react.createElement(
      formik_dist.Field,
      {
        as: dist.TextInput,
        name: "name",
