"use strict";
(self["webpackChunkcms"] = self["webpackChunkcms"] || []).push([[3981],{
...
const GuidedTourHomepage = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 6 }, /* @__PURE__ */ react.createElement(dist.Typography, { variant: "beta", as: "h2" }, formatMessage({
...
const SocialLinks = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(dist.Box, { paddingBottom: 7 }, /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 5 }, /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 3 }, /* @__PURE__ */ react.createElement(dist.Typography, { variant: "delta", as: "h2", id: "join-the-community" }, formatMessage({
...
const HomeHeader = ({ hasCreatedContentType, onCreateCT }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement(dist.Box, { paddingLeft: 6, paddingBottom: 10 }, /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "flex-start", gap: 5 }, /* @__PURE__ */ react.createElement(dist.Typography, { as: "h1", variant: "alpha" }, hasCreatedContentType ? formatMessage({
...
const ContentBlocks = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 5 }, /* @__PURE__ */ react.createElement(HomePage_CloudBox, null), /* @__PURE__ */ react.createElement(
