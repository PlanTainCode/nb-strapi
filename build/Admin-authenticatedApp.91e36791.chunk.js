"use strict";
(self["webpackChunkcms"] = self["webpackChunkcms"] || []).push([[801],{
...
const package_namespaceObject = {"i8":"4.8.2"};
...
const Content = ({ id, defaultMessage }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 4, paddingBottom: 6 }, formatMessage(
    { id, defaultMessage },
    {
...
const Bold = (children) => /* @__PURE__ */ react.createElement(dist.Typography, { fontWeight: "semiBold" }, children);
const Paragraph = (children) => /* @__PURE__ */ react.createElement(dist.Typography, null, children);
const Light = (children) => /* @__PURE__ */ react.createElement(dist.Typography, { textColor: "neutral600" }, children);
const List = (children) => /* @__PURE__ */ react.createElement(dist.Box, { paddingLeft: 6 }, /* @__PURE__ */ react.createElement("ul", null, children));
...
const LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  return /* @__PURE__ */ react.createElement(MainNav/* MainNav */.$, { condensed }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(dist.FocusTrap, { onEscape: handleToggleUserLinks }, /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 0 }, /* @__PURE__ */ react.createElement(LinkUser, { tabIndex: 0, onClick: handleToggleUserLinks, to: "/me" }, /* @__PURE__ */ react.createElement(dist.Typography, null, formatMessage({
      id: "global.profile",
...
const Onboarding = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.Box, { as: "aside", position: "fixed", bottom: 2, right: 2 }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(dist.FocusTrap, { onEscape: handlePopoverVisibility }, /* @__PURE__ */ react.createElement(
      ...
      docLinks.map(({ label, href, icon }) => /* @__PURE__ */ react.createElement(dist.Flex, { gap: 3, key: href }, /* @__PURE__ */ react.createElement(dist.Icon, { as: icon, color: "primary600" }), /* @__PURE__ */ react.createElement(
        TextLink,
        {
          as: "a",
          href,
...
const CM = (0,react.lazy)(
  () => Promise.all(/* import() | content-manager */[__webpack_require__.e(3852), __webpack_require__.e(3187), __webpack_require__.e(994)]).then(__webpack_require__.bind(__webpack_require__, 79932))
);
