...
const BulkMoveDialog = ({ onClose, selected, currentFolder }) => {
  ...
  }))), /* @__PURE__ */ react.createElement(dist.ModalBody, null, /* @__PURE__ */ react.createElement(dist.Grid, { gap: 4 }, /* @__PURE__ */ react.createElement(dist.GridItem, { xs: 12, col: 12 }, /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 1 }, /* @__PURE__ */ react.createElement(dist.FieldLabel, { htmlFor: "folder-destination" }, formatMessage({
...
const BulkActions = ({ selected, onSuccess, currentFolder }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(dist.Flex, { gap: 2, paddingBottom: 5 }, /* @__PURE__ */ react.createElement(dist.Typography, { variant: "epsilon", textColor: "neutral600" }, formatMessage(
    {
...
const Header = ({
  ...
  return /* @__PURE__ */ react.createElement(
    dist.HeaderLayout,
    {
      ...
      primaryAction: canCreate && /* @__PURE__ */ react.createElement(dist.Flex, { gap: 2 }, /* @__PURE__ */ react.createElement(dist.Button, { startIcon: /* @__PURE__ */ react.createElement(icons_dist.Plus, null), variant: "secondary", onClick: onToggleEditFolderDialog }, formatMessage({
