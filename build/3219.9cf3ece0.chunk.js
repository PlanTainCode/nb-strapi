"use strict";
(self["webpackChunkcms"] = self["webpackChunkcms"] || []).push([[3219],{
...
const schema = yup_lib/* object */.Ry().shape({
  name: yup_lib/* string */.Z_(helper_plugin.translatedErrors.string).max(100).required(helper_plugin.translatedErrors.required),
