"use strict";
(self["webpackChunkcms"] = self["webpackChunkcms"] || []).push([[4121],{
...
const ListView = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.Layout, null, /* @__PURE__ */ react.createElement(helper_plugin.SettingsPageTitle, { name: "Webhooks" }), /* @__PURE__ */ react.createElement(dist.Main, { "aria-busy": isLoading || loadingWebhooks }, /* @__PURE__ */ react.createElement(
  ...
  ), /* @__PURE__ */ react.createElement(dist.ContentLayout, null, isLoading || loadingWebhooks ? /* @__PURE__ */ react.createElement(dist.Box, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(helper_plugin.LoadingIndicatorPage, null)) : rowsCount > 0 ? /* @__PURE__ */ react.createElement(
    dist.Table,
    {
      colCount: 5,
      rowCount: rowsCount + 1,
      footer: /* @__PURE__ */ react.createElement(dist.TFooter, { onClick: () => canCreate ? handleGoTo("create") : {}, icon: /* @__PURE__ */ react.createElement(icons_dist.Plus, null) }, formatMessage({
        id: "Settings.webhooks.list.button.add",
        defaultMessage: "Create new webhook"
      }))
    },
    ...
    /* @__PURE__ */ react.createElement(dist.Tbody, null, webhooks.map((webhook) => /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(dist.Td, null, /* @__PURE__ */ react.createElement(dist.Flex, { gap: 1, ...helper_plugin.stopPropagation }, canUpdate && /* @__PURE__ */ react.createElement(
        dist.IconButton,
        {
          onClick: () => {
