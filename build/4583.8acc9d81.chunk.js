(self["webpackChunkcms"] = self["webpackChunkcms"] || []).push([[4583],{
...
const FormHead = ({
  ...
  return /* @__PURE__ */ react.createElement(
    design_system_dist.HeaderLayout,
    {
      ...
      primaryAction: canEditInputs ? /* @__PURE__ */ react.createElement(design_system_dist.Flex, { gap: 2 }, canRegenerate && token?.id && /* @__PURE__ */ react.createElement(
        Tokens_Regenerate,
        {
...
function BoundRoute({ route }) {
  ...
  return /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 2 }, /* @__PURE__ */ react.createElement(dist.Typography, { variant: "delta", as: "h3" }, formatMessage({
    id: "Settings.apiTokens.createPage.BoundRoute.title",
    defaultMessage: "Bound route to"
  }), "\xA0", /* @__PURE__ */ react.createElement("span", null, controller), /* @__PURE__ */ react.createElement(dist.Typography, { variant: "delta", textColor: "primary600" }, ".", action)), /* @__PURE__ */ react.createElement(dist.Flex, { hasRadius: true, background: "neutral0", borderColor: "neutral200", gap: 0 }, /* @__PURE__ */ react.createElement(MethodBox, { background: colors.background, borderColor: colors.border, padding: 2 }, /* @__PURE__ */ react.createElement(dist.Typography, { fontWeight: "bold", textColor: colors.text }, method)), /* @__PURE__ */ react.createElement(dist.Box, { paddingLeft: 2, paddingRight: 2 }, map_default()(formattedRoute, (value) => /* @__PURE__ */ react.createElement(dist.Typography, { key: value, textColor: value.includes(":") ? "neutral600" : "neutral900" }, "/", value)))));
}
...
const ActionBoundRoutes = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    selectedAction ? /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 2 }, routes[actionSection]?.map((route) => {
    ...
    })) : /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 2 }, /* @__PURE__ */ react.createElement(dist.Typography, { variant: "delta", as: "h3" }, formatMessage({
...
const Permissions = ({ ...props }) => {
  ...
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(dist.Grid, { gap: 0, shadow: "filterShadow", hasRadius: true, background: "neutral0" }, /* @__PURE__ */ react.createElement(dist.GridItem, { col: 7, paddingTop: 6, paddingBottom: 6, paddingLeft: 7, paddingRight: 7 }, /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 2 }, /* @__PURE__ */ react.createElement(dist.Typography, { variant: "delta", as: "h2" }, formatMessage({
...
const ApiTokenCreateView = () => {
  ...
  return /* @__PURE__ */ react.createElement(ApiTokenPermissionsContextProvider, { value: providerValue }, /* @__PURE__ */ react.createElement(dist.Main, null, /* @__PURE__ */ react.createElement(helper_plugin.SettingsPageTitle, { name: "API Tokens" }), /* @__PURE__ */ react.createElement(
    ...
    ({ errors, handleChange, isSubmitting, values, setFieldValue }) => {
      ...
      ), /* @__PURE__ */ react.createElement(dist.ContentLayout, null, /* @__PURE__ */ react.createElement(dist.Flex, { direction: "column", alignItems: "stretch", gap: 6 }, Boolean(apiToken?.name) && /* @__PURE__ */ react.createElement(TokenBox/* default */.Z, { token: apiToken?.accessKey, tokenType: constants/* API_TOKEN_TYPE */.Z }), /* @__PURE__ */ react.createElement(
...
const schema = lib/* object */.Ry().shape({
  name: lib/* string */.Z_(helper_plugin.translatedErrors.string).max(100).required(helper_plugin.translatedErrors.required),
